package com.monsters.maproom_advanced
{
   ...
   public class PopupInfoEnemy extends PopupInfoEnemy_CLIP
   {
      ...
      private function TakeOverConfirm() : void
      {
         ...
         var takeoverVars:Array = [["baseid",this._cell._baseID],["resources",encodeJson({
      ...
      private function Update() : void
      {
         ...
         {
            _loc1_ += "<br>_monsterData:" + encodeJson(this._cell._monsterData);
            _loc1_ += "<br>_monsterData.saved:" + encodeJson(this._cell._monsterData.saved);
            _loc1_ += "<br>_monsterData.h:" + encodeJson(this._cell._monsterData.h);
