package com.monsters.baseplanner
{
   ...
   public class BaseTemplate implements IExportable
   {
      ...
      public var nodes:Vector.<com.monsters.baseplanner.BaseTemplateNode>;
      
      public var slot:uint;
      
      public function BaseTemplate(param1:String = null, param2:Vector.<com.monsters.baseplanner.BaseTemplateNode> = null)
      {
         super();
         ...
         {
            this.nodes = new Vector.<com.monsters.baseplanner.BaseTemplateNode>();
         }
      }
      
      public function addNode(param1:com.monsters.baseplanner.BaseTemplateNode) : void
      {
      ...
      public function importData(param1:Object) : void
      {
         ...
         var _loc3_:com.monsters.baseplanner.BaseTemplateNode = null;
         for each(_loc2_ in param1)
         {
            if(!(_loc2_ is Number))
            {
               _loc3_ = new com.monsters.baseplanner.BaseTemplateNode();
