package com.monsters.maproom_inferno.views
{
   ...
   public class ListView extends ListView_CLIP
   {
      ...
      public var bNext:com.monsters.maproom_inferno.views.ListViewArrow;
      
      public var bPrevious:com.monsters.maproom_inferno.views.ListViewArrow;
      ...
      public function ListView()
      {
         ...
         this.bPrevious = new com.monsters.maproom_inferno.views.ListViewArrow();
         this.bPrevious.rotation = 180;
         this.bPrevious.x = -20;
         this.bPrevious.y = 190;
         this.bPrevious.Trigger();
         addChild(this.bPrevious);
         this.bNext = new com.monsters.maproom_inferno.views.ListViewArrow();
         this.bNext.x = 720;
         this.bNext.y = 190;
         this.bNext.Trigger();
         addChild(this.bNext);
