package {
    ...
    public class UI_TOP extends UI_TOP_CLIP {
        ...
        private function setupAttackMode():void {
            ...
            if (mc.mcPoints.mcStar)
                mc.mcPoints.mcStar.visible = false;
            if (mc.mcPoints.mcLevel)
                mc.mcPoints.mcLevel.visible = false;
            if (mc.mcPoints.mcBar)
                mc.mcPoints.mcBar.visible = false;
