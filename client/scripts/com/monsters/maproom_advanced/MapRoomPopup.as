package com.monsters.maproom_advanced
{
   ...
   internal class MapRoomPopup extends MapRoomPopup_CLIP
   {
      ...
      /*
         Backyard Monster's World Map uses an flat top oriented hexagonal grid with
         an odd-q offsetted coordinate system. (https://www.redblobgames.com/grids/hexagons/#coordinates-offset)
         This is literally the worst possible coordinate system to use as it makes calculations 
         quite cumbersome. 
         Rewriting the coordinate system is out of the question, but we can convert
         the coordinates to axial coordinates for the calculations and then bring them back. 
