package gameloaders
{
     ...
     *
     * This lives in a separate SWF file called "gameloader-android.swf" which is the initial entry point when the game is launched.
     */
    public class GAMELOADER_ANDROID extends Sprite
    {
        ...
        public function GAMELOADER_ANDROID()
        {
            super();
