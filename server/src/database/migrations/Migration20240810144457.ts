...
export class Migration20240810144457 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table `world_map_cell` (`cellid` int unsigned not null auto_increment primary key, `world_id` varchar(255) not null, `x` int not null, `y` int not null, `uid` int not null, `base_type` int not null, `base_id` int not null, `terrain_height` int not null, `world_uuid` varchar(255) not null) default character set utf8mb4 engine = InnoDB;');
